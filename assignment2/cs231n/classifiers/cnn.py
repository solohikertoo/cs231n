...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        Hpool = H//2
        Wpool = W//2
        hidden_input_dim = Hpool*Wpool*F
    ...
    def loss(self, X, y=None):
        ...
        conv_relu_pool_out = np.reshape(conv_relu_pool_out, (-1,hidden_input_dim))
        ...
        dh, grads['W3'], grads['b3'] = affine_backward(ds, scores_cache)
        dh, grads['W2'], grads['b2'] = affine_relu_backward(dh, affine_relu_cache)
        dh = np.reshape(dh, (-1, F, Hpool, Wpool))
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dh, conv_relu_pool_cache)
